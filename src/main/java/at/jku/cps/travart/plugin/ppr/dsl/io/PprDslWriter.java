...
public class PprDslWriter implements IWriter<AssemblySequence> {
	...
	public void write(final AssemblySequence asq, final Path path)
		...
		final AssemblySequenceDslSerializer asqWriter = new AssemblySequenceDslSerializer(attributeWriter,
				productWriter, resourceWriter, processWriter, constraintWriter);
